...
How To Get Started
------------------
Clone project from [here](http:github.com).
...
-----------------------
An example that uses this core api and the Android account manager can be found here: [Android Spreadsheet Example] (http://github.com)

How to use the Java Client
--------------------------
An example that uses this core api and OAuth authentication can be found here: [Java Google Spreadsheet Example] (http://github.com)
